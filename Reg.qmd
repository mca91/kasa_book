...
Ähnlich wie bei Probit-Regression ist der Einfluss von $X$ auf den Logit linear, jedoch besteht auch hier eine nicht-lineare Beziehung zwischen dem linearen Prädiktor und der Wahrscheinlichkeit $P(Y=1\vert X)$: $\Lambda(\cdot)$ ist eine nicht-lineare Funktion mit dem Wertebereich $[0,1]$.
...
\begin{align*}
   \lambda =&\, \exp(\beta_0 + \beta_1 X) \\
    ...
    =&\, \lambda \cdot \cdot exp(\beta\Delta X)
\end{align*}
