...
# beacause there's some issue with readr::read_csv
...
//| fig-height: 3
//| fig-align: 'center'
//| fig-cap: "Geschlecht ist Backdoor-Pfad"
...
digraph {
  ...
  node [shape=none];
  "read_time" [pos="4,1!", fontname="Helvetica,Arial,mono"]
  "dark_mode" [pos="0,1!"]
  "male" [pos="2,-1!"]
  "dark_mode" -> "read_time"
  "male" -> "dark_mode"
...
Wir lesen zunächst den Datensatz *darkmode.csv* mit `readr::read_csv()` ein und verschaffen uns einen Überblick über die verfügbaren Variablen. 
...
//| fig-height: 3
//| fig-align: 'center'
//| fig-cap: "Möglicher DGP als Kausales Diagramm"
//| label: "fig-CDdarkmode2" 
digraph {
  layout=neato
  fontname="Helvetica,Arial,sans-serif"
  node [fontname="Helvetica,Arial,sans-serif"]
