...
//| fig-height: 4
//| fig-align: 'center'
//| fig-cap: "IV-Design in @Acemogluetal2020"
//| label: "fig-ADDdag" 
digraph IV_DAG {
  layout=neato
  fontname="Helvetica,Arial,sans-serif"
...
abd^[Der Datensatz stammt aus dem [MIT Economics Data Archive](https://economics.mit.edu/people/faculty/daron-acemoglu/data-archive).]
...
ADD_dat <- ADD_dat %>%
  filter(
    # Nur Wetter-Station in 30km Umkreis
    !is.na(sp3m1893_n30), 
