...
@CJM2020 (CMJ) schlagen eine Weiterentwicklung des McCrary-Tests vor, die höhere statistische Macht gegenüber Diskontinuitäten hat. Der CJM-Test ist im Paket `rddensity` implementiert.
...
plot <- rdplotdensity(
  rdd = CJM, 
  X = X, 
  type = "both" # für Punkte- und Linienplots
)
```
